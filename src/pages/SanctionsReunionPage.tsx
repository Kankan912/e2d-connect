...
import { Plus, AlertTriangle, Users, DollarSign, Calendar } from "lucide-react";
...
export default function SanctionsReunionPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <LogoHeader 
        ...
        subtitle="Gestion des sanctions disciplinaires lors des réunions"
      />
